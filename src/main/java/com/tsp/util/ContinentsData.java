...
// this class is similar to CityData but just for the NearestNeighbour algorithm
// since the subregions are in a sepereate CSV file
public class ContinentsData {
  ...
  public ContinentsData(String resourcePath) {
